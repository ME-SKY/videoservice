...
class MoviesComponent {
    constructor(searchService, route) {
        ...
        this.route = route;
        this.posterUrl = 'assets/images/movie-posters/lokiposter.jpg';
        this.customOptions = {
            items: 4,
            loop: false,
            mouseDrag: true,
        ...
        this.filteredMovies$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](null);
...
MoviesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MoviesComponent, selectors: [["app-movies"]], decls: 15, vars: 8, consts: [[1, "movies-container"], [1, "new"], [1, "title"], [1, "text"], [1, "new-items"], [3, "options", "dragging"], [4, "ngFor", "ngForOf"], [1, "genres"], [3, "scrollBarWidth"], [1, "genre-items"], ["class", "genre-item", 4, "ngFor", "ngForOf"], ["carouselSlide", ""], [1, "new-item", "slider-item", 3, "owlRouterLink", "stopLink"], [1, "image"], ["alt", "", 1, "preview-poster", 3, "src"], [1, "movie-description"], [1, "short-description", "remove-to-name"], [1, "genre-item"], [1, "genre-icon"], [1, "genre-name"]], template: function MoviesComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_4__["CarouselComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _scroll_bar_scroll_bar_scroll_bar_component__WEBPACK_IMPORTED_MODULE_6__["ScrollBarComponent"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_4__["CarouselSlideDirective"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_4__["OwlRouterLinkDirective"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["AsyncPipe"]], styles: [".movies-container[_ngcontent-%COMP%] {\n  overflow: hidden;\n  -ms-overflow-style: none;\n  \n  scrollbar-width: none;\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  width: 1180px;\n}\n.movies-container[_ngcontent-%COMP%]::-webkit-scrollbar {\n  display: none;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%] {\n  overflow-x: hidden;\n  display: flex;\n  flex-flow: column;\n  height: 482px;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  width: 134px;\n  height: 28px;\n  margin-bottom: 20px;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%]   .text[_ngcontent-%COMP%] {\n  font-family: Rubik, serif;\n  font-style: normal;\n  font-weight: 500;\n  font-size: 24px;\n  line-height: 28px;\n  color: #333333;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .new-items[_ngcontent-%COMP%] {\n  -ms-overflow-style: none;\n  \n  scrollbar-width: none;\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-auto-flow: column;\n  grid-column-gap: 20px;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .new-items[_ngcontent-%COMP%]::-webkit-scrollbar {\n  display: none;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .new-item[_ngcontent-%COMP%] {\n  height: 434px;\n  width: 280px;\n  outline: none;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .new-item[_ngcontent-%COMP%]   .image[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template: 1fr/1fr;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .new-item[_ngcontent-%COMP%]   .image[_ngcontent-%COMP%]   .preview-poster[_ngcontent-%COMP%] {\n  grid-column: 1/1;\n  grid-row: 1/1;\n  z-index: 3;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .new-item[_ngcontent-%COMP%]   .image[_ngcontent-%COMP%]   .movie-description[_ngcontent-%COMP%] {\n  border-radius: 8px;\n  font-family: Rubik, serif;\n  font-size: 16px;\n  font-weight: normal;\n  font-stretch: normal;\n  font-style: normal;\n  line-height: 1.4;\n  letter-spacing: normal;\n  text-align: left;\n  color: #f2f2f2;\n  padding: 16px;\n  box-sizing: border-box;\n  -webkit-backdrop-filter: brightness(0.3);\n          backdrop-filter: brightness(0.3);\n  width: 280px;\n  height: 370px;\n  grid-column: 1/1;\n  grid-row: 1/1;\n  opacity: 0;\n  z-index: 5;\n}\n.movies-container[_ngcontent-%COMP%]   .new[_ngcontent-%COMP%]   .new-item[_ngcontent-%COMP%]   .image[_ngcontent-%COMP%]   .movie-description[_ngcontent-%COMP%]:hover {\n  opacity: 1;\n  cursor: pointer;\n}\n.movies-container[_ngcontent-%COMP%]   .genres[_ngcontent-%COMP%] {\n  display: flex;\n  flex-flow: column nowrap;\n  width: 1180px;\n  overflow-x: hidden;\n}\n.movies-container[_ngcontent-%COMP%]   .genres[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  width: 134px;\n  height: 28px;\n  margin-bottom: 20px;\n  font-family: Rubik, monospace;\n  font-style: normal;\n  font-weight: 500;\n  font-size: 24px;\n  line-height: 28px;\n  color: #333333;\n}\n.movies-container[_ngcontent-%COMP%]   .genres[_ngcontent-%COMP%]   .genre-items[_ngcontent-%COMP%] {\n  -ms-overflow-style: none;\n  \n  scrollbar-width: none;\n  \n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-auto-flow: column;\n  grid-column-gap: 20px;\n}\n.movies-container[_ngcontent-%COMP%]   .genres[_ngcontent-%COMP%]   .genre-items[_ngcontent-%COMP%]::-webkit-scrollbar {\n  display: none;\n}\n.movies-container[_ngcontent-%COMP%]   .genres[_ngcontent-%COMP%]   .genre-items[_ngcontent-%COMP%]   .genre-item[_ngcontent-%COMP%] {\n  position: relative;\n  height: 208px;\n  width: 280px;\n  border-radius: 6px;\n  box-shadow: inset 0 0 16px 0 rgba(0, 0, 0, 0.15);\n  background: linear-gradient(45deg, #ff0000, #ff9900, #ccff00, #00d0ff, #6e00ff) fixed top center;\n  display: flex;\n  flex-flow: column nowrap;\n  align-items: center;\n  justify-content: center;\n}\n.movies-container[_ngcontent-%COMP%]   .genres[_ngcontent-%COMP%]   .genre-items[_ngcontent-%COMP%]   .genre-item[_ngcontent-%COMP%]   .genre-icon[_ngcontent-%COMP%] {\n  width: 48px;\n  height: 48px;\n  font-size: 48px;\n  display: flex;\n  align-items: center;\n}\n.movies-container[_ngcontent-%COMP%]   .genres[_ngcontent-%COMP%]   .genre-items[_ngcontent-%COMP%]   .genre-item[_ngcontent-%COMP%]   .genre-name[_ngcontent-%COMP%] {\n  font-size: 20px;\n  position: absolute;\n  bottom: 24px;\n}\n.movies-container[_ngcontent-%COMP%]   .genres[_ngcontent-%COMP%]   .genre-items[_ngcontent-%COMP%]   .genre-item[_ngcontent-%COMP%]:hover {\n  cursor: pointer;\n}\n.preview-poster[_ngcontent-%COMP%] {\n  width: 280px !important;\n  height: 370px;\n  border-radius: 8px;\n}\n.short-description[_ngcontent-%COMP%] {\n  margin-top: 12px;\n  min-width: 280px;\n  min-height: 48px;\n  font-family: Rubik, serif;\n  font-style: normal;\n  font-weight: normal;\n  font-size: 20px;\n  line-height: 24px;\n  color: #333333;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/* harmony import */ var _core_providers_movie_resolver_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./core/providers/movie-resolver.service */ "x/u7");
/* harmony import */ var _src_app_core_providers_movies_resolver_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @src-app/core/providers/movies-resolver.service */ "PUkM");
...
const routes = [
    ...
    },
    {
        ...
        resolve: {
            moviesData: _src_app_core_providers_movies_resolver_service__WEBPACK_IMPORTED_MODULE_5__["MoviesResolverService"]
        }
    },
    {
        path: 'movie/:id', component: _main_movie_movie_movie_component__WEBPACK_IMPORTED_MODULE_2__["MovieComponent"],
        resolve: {
            movieData: _core_providers_movie_resolver_service__WEBPACK_IMPORTED_MODULE_4__["MovieResolverService"]
        }
    },
];
